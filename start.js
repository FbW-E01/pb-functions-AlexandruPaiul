...
// * sumOfCubes(2) ➞ 8
// * sumOfCubes() ➞ 0
// const sumOfCubes = (a,b,c)=> a**3+b**3+c**3;
// const result2 = sumOfCubes(1,5,9);
// console.log(result2);

const sumOfCubes1 = (...args) =>{
    result2 = 0;
...
console.log("Task2:",sumOfCubes1(2,3));
...
const isStrStartOfWord = (start,word)=> {
    let n = word.startsWith(start);
    return n;
}
const result3 = isStrStartOfWord("bon","bonjour");
console.log("Task3:",result3)
...
// let str = "this is a string and one more string";
// let ch ="i";
// console.log(str.split("i").length-1);
const result5 = countOccurrences("iioio","i");
...
const result6 = calcBaseToExponent(3,3);
...
const dogAge = (a) => a*7;
const result7 = dogAge(2);
console.log("Task7:",`Your dog is ${result7} years old in dog years`);
...
const calcLifetimeSupply = (a, b) => ((100-a)*365+Math.round((100-a)/4))*b;
const result8 = calcLifetimeSupply(40,3);
console.log("Task8:",`The snack company should provide you with ${result8} units, until you are a ripe old age of 100. Happy snacking!`)
...
const isWaldoHere = (a) => a.toLowerCase().includes("waldo");
console.log("Task9:",isWaldoHere("I found you Waldo!"));
// **10. Pie.**
...
const isEqualSlices = (a,b,c) => b*c<=a;
const result10 =  isEqualSlices(25,5,5);
console.log("Task10:",result10)
...
const isEqualNumXandO = (str1) =>{
    str1 = str1.toLowerCase();
    const result11 = countOccurrences(str1,"o")===countOccurrences(str1,"x") || (countOccurrences(str1,"o") && countOccurrences(str1,"x"))===0;
    return result11;
}

console.log("Task11:", isEqualNumXandO("zpzpzpp"));

// **12. isPrime?**
// Create a function that returns true if a number is a prime number, and false if it's not. 
